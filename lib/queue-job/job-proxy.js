    ...
    try {
      ...
      var options = {
        ...
        json: {
            ...
            "args": [JSON.stringify(data)], // args to give to the job file (array of strings): pull data from "data" object and pass as parameters to the job 
            "name": "new-job-name" // job name
        }
      };

      console.log('Posting to livy');
